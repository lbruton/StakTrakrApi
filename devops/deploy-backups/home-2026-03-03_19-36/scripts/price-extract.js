...
// Cox WiFi tinyproxy (port 8888) — Cox residential proxy.
...
async function main() {
  ...
  log(`Proxy config: HOME_PROXY_URL=${HOME_PROXY_URL ? "SET" : "NOT SET"}, WEBSHARE=${PROXY_HTTP ? "SET" : "NOT SET"}, PLAYWRIGHT_LAUNCH=${PLAYWRIGHT_LAUNCH}`);
